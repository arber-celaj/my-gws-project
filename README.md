...
The hardcoded version was created to demonstrate how the group assignment logic works, while this dynamic version builds on that logic by fetching group data directly from Google Workspace to ensure accuracy and ease of maintenance.
